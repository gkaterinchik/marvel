...
Page<Character> find(String name,String nameStartsWith, Integer comics, Integer page,String sortBy);
...
Page<Character> getAllCharactersByComicsId(Integer ComicsId, String name, String description, Integer comics, Integer page,String sortBy);
